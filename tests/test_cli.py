...
def test_broker_connect_uses_configured_broker_and_writes_audit_log(
    ...
    monkeypatch.setattr("sentinel_iron.cli_commands.broker.create_broker_route", create_fake_route)
...
def test_broker_connect_reports_factory_errors(monkeypatch, capsys):
    ...
    monkeypatch.setattr("sentinel_iron.cli_commands.broker.create_broker_route", create_failing_route)
