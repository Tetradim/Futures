...
from sentinel_iron.brokers.ninjatrader.config import BrokerEnvironment, NinjaTraderConfig
...
class FailingTransport(RecordingTransport):
    ...
    def request(
        ...
        from sentinel_iron.brokers.ninjatrader.adapter import NinjaTraderHttpError
...
def _adapter(transport: RecordingTransport):
    from sentinel_iron.brokers.ninjatrader.adapter import NinjaTraderBroker
