...
from sentinel_iron.brokers.tradestation.config import BrokerEnvironment, TradeStationConfig
...
class FailingTransport(RecordingTransport):
    ...
    def request(
        ...
        from sentinel_iron.brokers.tradestation.adapter import TradeStationHttpError
...
def _adapter(transport: RecordingTransport):
    from sentinel_iron.brokers.tradestation.adapter import TradeStationBroker
