...
from sentinel_iron.brokers.tradovate.config import BrokerEnvironment, TradovateConfig
...
class FailingTransport(RecordingTransport):
    ...
    def request(
        ...
        from sentinel_iron.brokers.tradovate.adapter import TradovateHttpError
