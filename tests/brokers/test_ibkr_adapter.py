...
from sentinel_iron.brokers.ibkr.config import BrokerEnvironment, IbkrConfig
...
def _adapter(client: RecordingIbkrClient):
    from sentinel_iron.brokers.ibkr.adapter import IbkrBroker
...
def test_ibkr_adapter_maps_client_connection_errors():
    from sentinel_iron.brokers.ibkr.adapter import IbkrClientError
