...
from sentinel_iron.brokers.ibkr import IbkrBroker
from sentinel_iron.brokers.tastytrade import TastytradeBroker
from sentinel_iron.brokers.tradestation import TradeStationBroker
from sentinel_iron.brokers.tradovate import TradovateBroker
...
def _optimus_env() -> dict[str, str]:
    return {
        ...
        "OPTIMUS_APP_NAME": "sentinel-iron-test",
    }
...
def test_create_broker_returns_ninjatrader_adapter_from_environment():
    from sentinel_iron.brokers.factory import create_broker
    from sentinel_iron.brokers.ninjatrader import NinjaTraderBroker
...
def test_create_broker_returns_optimus_adapter_from_environment_when_bridge_url_is_configured():
    from sentinel_iron.brokers.factory import create_broker
    from sentinel_iron.brokers.optimus import OptimusBroker
