...
def _modules():
    from sentinel_iron.brokers.ibkr.ibapi_client import IbapiModules
...
def test_ibapi_tws_client_connects_and_starts_message_loop():
    from sentinel_iron.brokers.ibkr.ibapi_client import IbapiTwsClient, create_ibapi_app
...
def test_ibapi_tws_client_reports_missing_ibapi_dependency(monkeypatch):
    import sentinel_iron.brokers.ibkr.ibapi_client as ibapi_client
