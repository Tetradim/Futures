...
from sentinel_iron.ports.broker import BrokerCancellationError
...
def test_kill_switch_enforcement_cancels_working_orders_and_skips_terminal_orders():
    from sentinel_iron.application.kill_switch_enforcement import KillSwitchEnforcementService
