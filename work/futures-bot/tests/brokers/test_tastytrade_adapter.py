...
from futures_bot.brokers.tastytrade.config import BrokerEnvironment, TastytradeConfig
...
class FailingTransport(RecordingTransport):
    ...
    def request(
        ...
        from futures_bot.brokers.tastytrade.adapter import TastytradeHttpError
